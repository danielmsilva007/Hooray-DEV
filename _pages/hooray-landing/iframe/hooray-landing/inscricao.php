...
if ($_POST[mailsent] == md5("enviar"))
{
	...
	$categorias .= ($_POST["espAgua"] == "Esportes de Agua") ? ", " . $_POST["espAgua"] : "";
	$categorias .= ($_POST["espTerra"] == "Esportes de Terra") ? ", " . $_POST["espTerra"] : "";
	$categorias .= ($_POST["espAr"] == "Esportes de Ar") ? ", " . $_POST["espAr"] : "";
	$categorias .= ($_POST["vestuario"] == "Vestuario") ? ", " . $_POST["vestuario"] : "";
                ...
                <div class="sixteen columns">
                    ...
                    <div class="eight columns omega ">
                        <div class="highlight_inner">
                            <div class="left_text">
                                <h4 class="big_title margin_bottom" id="pre"><strong>Pré-inscrição</strong></h4>
								...
								<form id="contact_form" class="pix_form" pix-confirm="hidden_pix_4" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
                                    ...
                                    <label class="control control--checkbox">Esportes de Água
                                      <input type="checkbox" name="espAgua" id="espAgua" value="Esportes de Agua"/>
                                      <div class="control__indicator"></div>
                                    </label>
                                    <label class="control control--checkbox">Esportes de Terra
                                      <input type="checkbox" name="espTerra" id="espTerra" value="Esportes de Terra"/>
                                      <div class="control__indicator"></div>
                                    </label>
                                    <label class="control control--checkbox">Esportes de Ar
                                      <input type="checkbox" name="espAr" id="espAr" value="Esportes de Ar"/>
                                      <div class="control__indicator"></div>
                                    </label>
                                    <label class="control control--checkbox">Vestuário
                                      <input type="checkbox" name="vestuario" id="vestuario" value="Vestuario"/>
                                      <div class="control__indicator"></div>
                                    </label>
                                    ...
                                    <br><input type="text" name="outros-cat-define" id="outros-cat-define" placeholder="Quais outros produtos você vende?" />
